  ...
  return (
    <div className="farmer-dashboard w-full h-full">
      <div className="flex justify-between items-center">
        ...
        <div className="bg-[#CFE1B999] flex justify-between items-center p-6 rounded-lg gap-5">
          <div className="flex flex-col">
        ...
        <div className="bg-[#fff] flex justify-between items-center p-6 rounded-lg gap-5">
