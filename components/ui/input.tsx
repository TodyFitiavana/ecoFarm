...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, suffix, clear = "true", ...props }, ref) => {
    return (
      <div
        className={cn(
          "flex h-10 items-center rounded-md border border-input bg-white pl-3 text-sm ring-offset-background focus-within:ring-1 focus-within:ring-primary focus-within:ring-offset-2",
          className
        )}
      >
        <input
